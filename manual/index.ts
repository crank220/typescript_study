...
// 数字/浮点型数字： number 十进制、十六进制、二进制、八进制
let decLiteral: number = 6
let hexLiteral: number = 0xf00d
let binaryLiteral: number = 0b1010
let octalLiteral: number = 0o744

// 字符串 处理网页或服务器端的文本数据 文本数据类型：string “a”、'b'
let name1: string = "jane"
name1 = "smith"

let name2: string = "Gane"
let age2: number = 21
let sentence: string = `say hello, my name ${name2}, my age ${age2}`

// 数组: 两种方式可以定义数组。 第一种，可以在元素类型后面接上 []，表示由此类型元素组成的一个数组
// one：表示由此类型元素组成的一个数组
let list1: number[] = [1, 2, 3]
// two：使用数组泛型，Array<元素类型>
...
// Any:有时候，我们会想要为那些在编程阶段还不清楚类型的变量指定一个类型。 这些值可能来自于动态的内容
let notSure: any = 4;
...
// 这能避免 很多常见的问题。 也许在某处你想传入一个 string或null或undefined，你可以使用联合类型string | null | undefined。 再次说明，稍后我们会介绍联合类型。
...
// let关键字是JavaScript的一个新概念，TypeScript实现了它。 我们会在以后详细介绍它，很多常见的问题都可以通过使用 let来解决，所以尽可能地使用let来代替var吧。